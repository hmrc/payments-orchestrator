...
object DesData {
  ...
  private val approvedInformation =
    ApprovedInformation(
      ...
      Some(BankDetails(Some("Account holder"), Some("11112222"), Some("667788"), None, None)),
  ...
  val customerInformation: CustomerInformation =
    CustomerInformation(Some(approvedInformation), Some(InFlightInformation(Some(ChangeIndicators(Some(true), Some(false))), Some(InFlightChanges(Some(BankDetails(Some("Account holder"), Some("11112222"), Some("667788"), None, Some(FormInformation(Some("2019-03-04"))))))))))
